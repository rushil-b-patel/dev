    ...
    return (
        <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40 hidden xl:block">
            <div className="group flex items-center">
                <div className="mr-2 max-w-56 opacity-0 translate-x-3 scale-[0.97] group-hover:opacity-100 group-hover:translate-x-0 group-hover:scale-100 transition-all duration-300 ease-out pointer-events-none group-hover:pointer-events-auto">
                ...
                <div className="pl-6 pr-5 py-8 cursor-default">
                    <div className="w-[3px] h-36 rounded-full bg-gray-300 dark:bg-neutral-600 opacity-20 group-hover:opacity-50 transition-opacity duration-300" />
                </div>
            </div>
        </div>
    );
